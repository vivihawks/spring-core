...
public class ContextRefreshedListenerIntegrationTest {
    ...
    public static void main (String ...args) {
    	ApplicationContext applicationContext = new AnnotationConfigApplicationContext(SynchronousSpringEventsConfig.class);
    	ContextRefreshedListener listener = applicationContext.getBean(ContextRefreshedListener.class);
		System.out.println(listener.isHitContextRefreshedHandler());
